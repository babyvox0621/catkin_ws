...
//<---panasonic add
      ...
      //kt_double maxRange = pScan->GetLaserRangeFinder()->GetMaximumRange();// panasonic del
...
//--->panasonic add
        if (pScan->GetRangeReadings()[readingIndex] < minRange || pScan->GetRangeReadings()[readingIndex] > maxRange)
        {
          pAngleIndexPointer[readingIndex] = INVALID_SCAN;
          readingIndex++;
          continue;
