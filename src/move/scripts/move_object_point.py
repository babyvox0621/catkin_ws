...
class MoveObjectPoint:
    def __init__(self):
        ...
        self.sub = rospy.Subscriber('object_point', PointStamped, self.callback)
    ...
    def callback(self, msg):
        ...
        try:
            trans1 = tfBuffer1.lookup_transform('base_link', 'optical_ranging_sensor_left', rospy.Time(0), rospy.Duration(3.0))
            trans2 = tfBuffer2.lookup_transform('map', 'base_link', rospy.Time(0), rospy.Duration(3.0))
        except (tf2_ros.LookupException, tf2_ros.ConnectivityException, tf2_ros.ExtrapolationException) as e:
            print(e)
        else:
 
        	goal = self.transform_pose(self.calc_goal(self.transform_point(msg.point, trans1)), trans2)
